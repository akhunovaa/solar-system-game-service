...
@RestController
@RequestMapping("/api/nn-solar-system-kafka")
public class NnSolarSystemKafkaResource {

    private final Logger log = LoggerFactory.getLogger(NnSolarSystemKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public NnSolarSystemKafkaResource(KafkaProperties kafkaProperties) {
